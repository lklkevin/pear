...
export default function AuthLayout({ children, text }: AuthLayoutProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-zinc-950 sm:px-8">
      ...
      <div className="h-screen justify-center sm:h-auto flex flex-col z-[999] bg-zinc-900 text-white py-6 sm:rounded-xl shadow-lg shadow-zinc-950/25 w-full sm:max-w-[28rem] mx-auto sm:border overflow-hidden border-zinc-800">
        {children}
      </div>
    </div>
  );
