...
const LandingLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <Nav landing={true} />
      <main className="flex flex-1 flex-col h-full relative container w-screen mx-auto py-8 tracking-normal justify-center items-center">
        {/* White Glow on the right */}
        <Glow
          className="top-[25%] md:top-[20%] lg:top-[15%] right-[25%] sm:right-[30%] md:right-[20%] xl:right-[25%] 2xl:right-[30%]
        ...
        <Glow
          className="top-[25%] md:top-[20%] lg:top-[15%] left-[25%] sm:left-[30%] md:left-[20%] xl:left-[25%] 2xl:left-[30%]
             w-[450px] h-[450px] md:w-[600px] md:h-[600px] lg:w-[900px] lg:h-[900px]"
